...
export const BuyAction = () => {
  ...
  const formattedAutoMinOutput =
    autoMinOutput !== undefined ? `${parseFloat(formatUnits(autoMinOutput, 18)).toFixed(4)} TOKEN` : "N/A";
  ...
  return (
    <div className="flex flex-col">
      ...
      <button className="bg-blue-500 text-white p-2 rounded mt-2 w-full" onClick={handleBuy}>
        Buy
      </button>
    </div>
  );
